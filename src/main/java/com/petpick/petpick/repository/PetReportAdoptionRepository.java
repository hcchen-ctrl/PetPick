...
public interface PetReportAdoptionRepository extends JpaRepository<PetReportAdoption, Long> {
    boolean existsByPostIdExtAndAdopterUserIdExt(Long postIdExt, Long adopterUserIdExt);

    Optional<PetReportAdoption> findByPostIdExtAndAdopterUserIdExt(Long postIdExt, Long adopterUserIdExt);
