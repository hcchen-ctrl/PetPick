...
CREATE TABLE `memberinfo` (
  ...
  `gender` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '性别(M:男生;F:女生)',
  ...
  `pet_experience` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '飼養經驗(N:無;Y:有)',
  ...
  `pet_activities` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '寵物個性',
...
INSERT INTO `memberinfo` (`user_id`, `phonenumber`, `icon`, `username`, `password`, `gender`, `accountemail`, `city`, `district`, `pet_experience`, `daily`, `activities`, `pet`, `pet_activities`, `isaccount`, `isblacklist`) VALUES
(1, '04-12345678', NULL, 'Amy', '123456', NULL, 'amy@example.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '0912345678', NULL, 'Yanyu', '123456', NULL, 'yanyu@123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(9, '15kg貓咪飼料', '營養均衡，貓咪最愛。', 1399, 16, 1, NULL, 'https://i.ibb.co/234vMVPZ/jia-yong-chong-wu-si-liao-de-zu-cheng.jpg', NULL, 'newest', '2025-08-24 22:07:12', 1),
(10, '狗狗玩具球', '耐咬不破，讓狗狗玩整天！', 199, 48, 1, NULL, 'https://i.ibb.co/23CqQTVN/chao-shi-de-shi-wu-biao-zhi.jpg', NULL, NULL, '2025-08-24 02:01:09', 1),
...
ALTER TABLE `shopping_cart`
  ...
  ADD UNIQUE KEY `unique_member_product` (`user_id`,`product_id`),
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `order_details`
--
ALTER TABLE `order_details`
  MODIFY `order_detail_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `shopping_cart`
  MODIFY `cart_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_orders_member` FOREIGN KEY (`user_id`) REFERENCES `memberinfo` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `shopping_cart`
  ADD CONSTRAINT `fk_cart_member` FOREIGN KEY (`user_id`) REFERENCES `memberinfo` (`user_id`) ON DELETE CASCADE,
